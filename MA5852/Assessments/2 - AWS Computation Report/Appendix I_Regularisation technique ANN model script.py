...
if __name__ == '__main__':
    ...
    def keras_model_fn(metrics=METRICS,
        ...
        x1 = Dense(40, kernel_regularizer=regularizer)(input_layer)
        x1 = PReLU()(x1)
        x1 = Dropout(rate=dropout)(x1)
        x2 = Dense(44, kernel_regularizer=regularizer)(x1)
        x2 = PReLU()(x2)
        x2 = Dropout(rate=dropout)(x2)
        output_layer = Dense(1, activation='sigmoid')(x2)

        model = Model(inputs=input_layer, outputs=output_layer, name='regularised_model')
