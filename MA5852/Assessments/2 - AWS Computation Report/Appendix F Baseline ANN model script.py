...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden-nodes1', type=float, default=8)
    parser.add_argument('--hidden-nodes2', type=float, default=4)
    ...
    EPOCHS = args.epochs
    HIDDEN_NODES1 = args.hidden_nodes1
    ...
    def keras_model_fn(metrics=METRICS,
                       ...
                       hidden_nodes1=HIDDEN_NODES1,
                       hidden_nodes2=HIDDEN_NODES2,
                       activation=ACTIVATION,
                       learning_rate=LEARNING_RATE):
        input_layer = tf.keras.Input(shape=(input_dim,))
        x1 = Dense(hidden_nodes1)(input_layer)
        x1 = activation()(x1)
        x2 = Dense(hidden_nodes2)(x1)
        x2 = activation()(x2)
